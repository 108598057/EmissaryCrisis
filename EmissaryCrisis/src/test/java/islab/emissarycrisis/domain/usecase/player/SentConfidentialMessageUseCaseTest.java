...
public class SentConfidentialMessageUseCaseTest {
    ...
    public void sentConfidentialMessageUseCase() {
        SentConfidentialMessageUseCase sentConfidentialMessageUseCase = new SentConfidentialMessageUseCase(playerRepository, gameCardRepository);
        ...
        input.setGameCardId(players.get(0).getGameCards().get(0).getId());
